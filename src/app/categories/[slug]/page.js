...
import { postsAPI, categoriesAPI, getImageUrl } from '@/lib/api';
  ...
  const fetchData = async () => {
    ...
    try {
      const [categoryRes, postsRes] = await Promise.all([
        ...
        postsAPI.getAll({ category: slug, page, limit: 9 }),
      ]);
      ...
      <div className="min-h-screen flex flex-col bg-background-dark">
        ...
        <main className="flex-1 py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-white mb-4 font-main">التصنيف غير موجود</h1>
            <p className="text-text-muted mb-6 font-main">عذراً، لم نتمكن من العثور على هذا التصنيف</p>
            <Link
              href="/categories"
    ...
    <div className="min-h-screen flex flex-col bg-background-dark">
      ...
      <section className="relative py-10 sm:py-12 lg:py-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 font-main">{category.name}</h1>
          {category.description && (
            <p className="text-text-muted font-main max-w-2xl text-sm sm:text-base">{category.description}</p>
          )}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className="text-center py-12 sm:py-16">
              ...
              <p className="text-text-muted mb-4 sm:mb-6 font-main text-sm sm:text-base">لا توجد مقالات في هذا التصنيف</p>
              <Link
                href="/"
