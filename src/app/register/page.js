    ...
    <div className="min-h-screen flex items-center justify-center bg-background-dark py-8 sm:py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="mt-4 sm:mt-6 text-xl sm:text-2xl font-bold text-white font-main">إنشاء حساب جديد</h2>
        ...
        <div className="bg-surface-dark rounded-lg sm:rounded-xl p-5 sm:p-8 ring-1 ring-white/5">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div>
              <label htmlFor="name" className="block text-xs sm:text-sm font-medium text-white mb-1.5 sm:mb-2 font-main">
                الاسم الكامل
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs sm:text-sm font-medium text-white mb-1.5 sm:mb-2 font-main">
                تأكيد كلمة المرور
              </label>
              <input
                id="confirmPassword"
